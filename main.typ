...
#let mainmatter={
  ...
  addpdf("数据通信与互联网","assets/Ch5A 数据通信与互联网-发布版-2025.pdf","1-11")
  addpdf("多媒体通信技术","assets/Ch6A 多媒体通信技术-发布版-2025.pdf","1-28")
  addpdf("微电子技术概述","assets/Ch7A 微电子技术概述-2025.pdf","1-50")
}
#default-template(
  [信息通信概论课件],
  [earth34online],
